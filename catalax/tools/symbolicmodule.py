...
_lookup = {
    concatenate: _single_args(bm.concatenate),
    stack: _single_args(bm.stack),
    sympy.Mul: _reduce(bm.multiply),
    sympy.Add: _reduce(bm.add),
    sympy.div: bm.divide,
    sympy.Abs: bm.abs,
    sympy.sign: bm.sign,
    sympy.ceiling: bm.ceil,
    sympy.floor: bm.floor,
    sympy.log: bm.log,
    sympy.exp: bm.exp,
    sympy.sqrt: bm.sqrt,
    sympy.cos: bm.cos,
    sympy.acos: bm.arccos,
    sympy.sin: bm.sin,
    sympy.asin: bm.arcsin,
    sympy.tan: bm.tan,
    sympy.atan: bm.arctan,
    sympy.atan2: bm.arctan2,
    sympy.cosh: bm.cosh,
    sympy.acosh: bm.arccosh,
    sympy.sinh: bm.sinh,
    sympy.asinh: bm.arcsinh,
    sympy.tanh: bm.tanh,
    sympy.atanh: bm.arctanh,
    sympy.Pow: bm.power,
    sympy.re: bm.real,
    sympy.im: bm.imag,
    sympy.arg: bm.angle,
    ...
    sympy.Eq: bm.equal,
    sympy.Ne: bm.not_equal,
    sympy.StrictGreaterThan: bm.greater,
    sympy.StrictLessThan: bm.less,
    sympy.LessThan: bm.less_equal,
    sympy.GreaterThan: bm.greater_equal,
    sympy.And: bm.logical_and,
    sympy.Or: bm.logical_or,
    sympy.Not: bm.logical_not,
    sympy.Xor: bm.logical_xor,
    sympy.Max: _reduce(bm.maximum),
