...
### `Predictor` <sup><a href="https://github.com/JR-1991/Catalax/blob/master/catalax/predictor.py#L14" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `widget` <sup><a href="https://github.com/JR-1991/Catalax/blob/master/catalax/predictor.py#L22" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `get_species_order` <sup><a href="https://github.com/JR-1991/Catalax/blob/master/catalax/predictor.py#L80" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `predict` <sup><a href="https://github.com/JR-1991/Catalax/blob/master/catalax/predictor.py#L87" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
predict(self, dataset: Dataset, config: Optional[SimulationConfig] = None, n_steps: int = 100, use_times: bool = False) -> Dataset
```
...
#### `n_parameters` <sup><a href="https://github.com/JR-1991/Catalax/blob/master/catalax/predictor.py#L110" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
