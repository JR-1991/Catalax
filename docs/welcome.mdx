...
1. **[Build your first model](/docs/usage/model-class)** - Learn the core Model class and basic simulation
2. **[Handle experimental data](/docs/usage/data-management)** - Import, process, and analyze your datasets  
3. **[Run parameter inference](/docs/usage/mcmc-basic)** - Quantify uncertainty with Bayesian methods

### Ready for Discovery?
Dive into data-driven approaches for unknown systems:

1. **[Train Neural ODEs](/docs/usage/neural-ode)** - Learn dynamics directly from data
2. **[Discover reaction networks](/docs/usage/reactflow-ode)** - Uncover biochemical mechanisms
3. **[Apply biological constraints](/docs/usage/regularization)** - Ensure realistic discoveries

### Want Maximum Performance?  
Explore advanced techniques for complex research problems:

1. **[Hybrid modeling](/docs/usage/universal-ode)** - Combine mechanistic and neural approaches
2. **[Surrogate acceleration](/docs/usage/surrogate-hmc)** - Achieve 10-100x inference speedup
3. **[Custom protocols](/docs/usage/pre-post-models)** - Extend models for complex scenarios
