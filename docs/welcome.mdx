...
1. **[Build your first model](/docs/basic/model-class)** - Learn the core Model class and basic simulation
2. **[Handle experimental data](/docs/basic/data-management)** - Import, process, and analyze your datasets  
3. **[Run parameter inference](/docs/hmc/mcmc-basic)** - Quantify uncertainty with Bayesian methods

### Ready for Discovery?
Dive into data-driven approaches for unknown systems:

1. **[Train Neural ODEs](/docs/neural/neural-ode)** - Learn dynamics directly from data
2. **[Discover reaction networks](/docs/neural/rateflow-ode)** - Uncover biochemical mechanisms
3. **[Apply biological constraints](/docs/neural/neural-regularization)** - Ensure realistic discoveries

### Want Maximum Performance and Flexibility?  
Explore advanced techniques for complex research problems:

1. **[Hybrid modeling](/docs/neural/universal-ode)** - Combine mechanistic and neural approaches
2. **[Surrogate acceleration](/docs/hmc/surrogate-hmc)** - Achieve 10-100x inference speedup
3. **[Custom protocols](/docs/hmc/pre-post-models)** - Extend models for complex scenarios
